...
import com.lunarclient.apollo.example.listeners.ApolloRoundtripListener;
...
public class TransferProtoExample {
    ...
    public void transferExample(Player player) {
        ...
        ApolloRoundtripListener.getInstance().sendRequest(player, requestId, transferRequestMessage, TransferResponse.class, response -> {
            String message = "";
    ...
    public void pingExample(Player player) {
        ...
        ApolloRoundtripListener.getInstance().sendRequest(player, requestId, pingRequestMessage, PingResponse.class, response -> {
