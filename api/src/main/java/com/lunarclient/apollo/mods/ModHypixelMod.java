...
public final class ModHypixelMod {
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Boolean> AUTO_G_G = SimpleOption.<Boolean>builder()
        .node("hypixel-mod", "auto-gg").type(TypeToken.get(Boolean.class))
        .defaultValue(false)
        .build();
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Boolean> ANTI_G_G = SimpleOption.<Boolean>builder()
        .node("hypixel-mod", "anti-gg").type(TypeToken.get(Boolean.class))
        .defaultValue(false)
        .build();
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Integer> LEVEL_COLOR = NumberOption.<Integer>number()
        .node("hypixel-mod", "level-color").type(TypeToken.get(Integer.class))
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Integer> LEVEL_HEAD_NUMBER_COLOR = NumberOption.<Integer>number()
        .node("hypixel-mod", "level-head-number-color").type(TypeToken.get(Integer.class))
        .defaultValue(0xFF55FFFF).min(0x80000000).max(0x7FFFFFFF)
        .build();
