...
public final class ModSba {
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Boolean> LEG_MONKEY_LVL_1_0_0 = SimpleOption.<Boolean>builder()
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Integer> ZEALOT_COLOR = NumberOption.<Integer>number()
        .node("sba", "zealot-color").type(TypeToken.get(Integer.class))
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Integer> END_ENDER_CHEST_COLOR = NumberOption.<Integer>number()
        .node("sba", "end-ender-chest-color").type(TypeToken.get(Integer.class))
        .defaultValue(0xFF202020).min(0x80000000).max(0x7FFFFFFF)
        .build();
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Integer> FISHING_PARTICLE_OVERLAY_COLOR = NumberOption.<Integer>number()
        .node("sba", "fishing-particle-overlay-color").type(TypeToken.get(Integer.class))
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Float> HEALING_CIRCLE_OPACITY = NumberOption.<Float>number()
        .node("sba", "healing-circle-opacity").type(TypeToken.get(Float.class))
        .defaultValue(0.4F).min(0.1F).max(1.0F)
        .build();
     ...
     * @since %release_version%
     */
    public static final SimpleOption<Boolean> SHOW_SKY_BLOCK_ITEM_I_D = SimpleOption.<Boolean>builder()
        .node("sba", "show-sky-block-item-id").type(TypeToken.get(Boolean.class))
        .defaultValue(false)
        .build();
