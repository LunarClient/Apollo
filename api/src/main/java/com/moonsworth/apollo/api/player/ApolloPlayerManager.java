...
public interface ApolloPlayerManager {
    ...
    /**
     * Gets the {@link ApolloPlayer} for the platform player if it
     * exists, otherwise returns {@link Optional#empty()}.
     *
     * @param platformPlayer the platform player
     * @return the apollo player, if present
     * @since 1.0.0
     */
    Optional<ApolloPlayer> getPlayer(final Object platformPlayer);

    /**
     * Gets a list of {@link ApolloPlayer}s that support Apollo.
     *
     * @return a list of apollo players
     * @since 1.0.0
     */
    List<ApolloPlayer> getPlayers();
