...
### Hiding a armor piece of a player
...
3. `ArmorPiece.TYPE`
   - The armor piece types you wish to hide on the `target` player. See the [armor pieces](#armorpiece-predefined-yypes) predefined section for more.
...
3. `ArmorPiece.TYPE`
   - The type of armor piece(s) you want to reset on the `target` player. See the [armor pieces](#armorpiece-predefined-yypes) predefined section for more.
