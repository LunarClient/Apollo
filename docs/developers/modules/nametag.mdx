...
<Callout type="info" emoji="ℹ️">
  ...
  We recommend doing a line above and a line below the nametag, for the best design.
  After a certain point, adding extra lines can start to look ugly.
</Callout>
...
{/* callout for char limits/recommendations per line char limit */}
