...
private void printOptionStatusExample(Player player) {
    ...
    apolloPlayerOpt.ifPresent(apolloPlayer -> {
        // https://lunarclient.dev/apollo/developers/mod-settings/waypoints#available-options
        boolean waypointsEnabled = this.modSettingModule.getStatus(apolloPlayer, ModWaypoints.ENABLED);

        // https://lunarclient.dev/apollo/developers/mod-settings/minimap#available-options
        float minimapScale = this.modSettingModule.getStatus(apolloPlayer, ModMinimap.SCALE);

        // https://lunarclient.dev/apollo/developers/mod-settings/fov#available-options
...
<Callout type="info">
**Sample code tabs:** [General (API examples)](/apollo/developers/general) · [Lightweight Protobuf](/apollo/developers/lightweight/protobuf/getting-started) · [Lightweight JSON](/apollo/developers/lightweight/json/getting-started)
</Callout>
