...
- __`HIDE_NAMETAGS_IN_F1`__
    - Config Key: `hide-nametags-in-f1`
    - Values
        - Type: `Boolean`
        - Default: `false`
...
- __`HIDE_NAMETAG_F5PASSENGERS`__
    - With this option enabled, your nametag will be hidden in third person when there is a passenger attached to you.
    - Config Key: `hide-nametag-f5-passengers`
    - Values
        - Type: `Boolean`
        - Default: `false`

- __`REPLACE_OWN_NAMETAG_COLOR`__
    - Config Key: `replace-own-nametag-color`
    - Values
        - Type: `Boolean`
        - Default: `false`

- __`OWN_NAMETAG_COLOR`__
    - Config Key: `own-nametag-color`
    - Values
        - Type: `String`
        - Default: `#FFFFFFFF`
