...
- __`EFFECT_BARS`__
    ...
    - Config Key: `effect-bars`
    - Values
        - Type: `Boolean`
        - Default: `false`

- __`EFFECT_BAR_VANILLA_HUD`__
    - Config Key: `effect-bar-vanilla-hud`
    - Values
        - Type: `Boolean`
        - Default: `true`

- __`EFFECT_BAR_INVENTORY`__
    - Config Key: `effect-bar-inventory`
    - Values
        - Type: `Boolean`
        - Default: `true`

- __`EFFECT_BAR_LUNAR_HUD`__
    - Show the duration bars on Lunar potion effect status huds
    - Config Key: `effect-bar-lunar-hud`
    - Values
        - Type: `Boolean`
        - Default: `false`

- __`EFFECT_BAR_HIDE_AMBIENT`__
    - Config Key: `effect-bar-hide-ambient`
    - Values
        - Type: `Boolean`
        - Default: `true`

- __`EFFECT_BAR_GRADIENT`__
    - Do a gradient animation on the bar color
    - Config Key: `effect-bar-gradient`
    - Values
        - Type: `Boolean`
        - Default: `true`

- __`EFFECT_BAR_CUSTOM_COLOR`__
    - Config Key: `effect-bar-custom-color`
    - Values
        - Type: `Boolean`
        - Default: `false`

- __`EFFECT_BAR_COLOR`__
    - Config Key: `effect-bar-color`
    - Values
        - Type: `String`
        - Default: `#FFFFFFFF`
