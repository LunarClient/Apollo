...
- __`CHAT_HEADS`__
    ...
    - Config Key: `chat-heads`
    - Values
        - Type: `Boolean`
        - Default: `false`

- __`CHAT_HEADS_FETCH_UNKNOWN`__
    ...
    - Config Key: `chat-heads-fetch-unknown`
    - Values
        - Type: `Boolean`
        - Default: `false`
...
- __`CHAT_EMOJI`__
    ...
    - Config Key: `chat-emoji`
    - Values
        - Type: `Boolean`
        - Default: `true`

- __`CHAT_EMOJI_UNICODE_ONLY`__
    ...
    - Config Key: `chat-emoji-unicode-only`
    - Values
        - Type: `Boolean`
        - Default: `false`

- __`CHAT_EMOJI_CONVERT_SHORTCODES`__
    ...
    - Config Key: `chat-emoji-convert-shortcodes`
    - Values
        - Type: `Boolean`
        - Default: `true`
