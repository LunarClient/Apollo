...
public static ItemStackIcon itemStackPlayerTextureIconExample() {
    return ItemStackIcon.builder()
...
The `Profile` builder is used to apply a player skin texture to a player head `ItemStackIcon`.
