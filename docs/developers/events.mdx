...
<details>
<summary>ApolloPlayerInventoryCloseEvent</summary>
...
<details>
<summary>ApolloPlayerInventoryOpenEvent</summary>
...
<details>
<summary>ApolloPlayerUseItemBucketEvent</summary>

### ApolloPlayerUseItemBucketEvent

_Called when the player uses a bucket (1.7 and 1.8)._
...
| `long instantiationTimeMs`      | The unix timestamp when the packet was created.     |
| `PlayerInfo playerInfo`         | The player's general information.                   |
| `RayTraceResult rayTraceResult` | The client ray trace result for the interaction.    |
