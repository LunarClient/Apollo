...
<Callout type="info">
  Need just the essentials? [Lightweight](/apollo/developers/lightweight/introduction) allows you to use Apollo features without the full plugin!
</Callout>
...
🔗 [Apollo GitHub Repository](https://github.com/LunarClient/Apollo)<br/>


## Where to start

🔗 [FAQ](/apollo/developers/faq)<br/>
🔗 [General](/apollo/developers/general)<br/>
🔗 [Events](/apollo/developers/events)<br/>
🔗 [Options](/apollo/developers/options)<br/>
🔗 [Modules](/apollo/developers/modules)<br/>
🔗 [Private Modules](/apollo/developers/private-modules)<br/>
🔗 [Mod Settings](/apollo/developers/mod-settings)<br/>
🔗 [Utilities](/apollo/developers/utilities)<br/>
🔗 [Minestom](/apollo/developers/minestom)<br/>
🔗 [Lightweight](/apollo/developers/lightweight)
