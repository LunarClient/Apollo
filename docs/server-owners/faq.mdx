...
However, we no longer recommend the legacy API, and you won't be able to use the newest features added to Apollo.
We will evenly discontinue support for the legacy API, so it's highly recommended updating to use Apollo.
