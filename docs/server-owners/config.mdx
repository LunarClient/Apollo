...
The `mods.yml` is not generated with its settings or comments, which will require you to refer to each mod’s documentation under [Mod Settings](/apollo/developers/mod-settings) for the keys and value(s) you can set.
...
<Callout type="warning" emoji="⚠️">
  ...
  You should refer to the [Mod Settings](/apollo/developers/mod-settings) documentation for the latest mod settings.
</Callout>
